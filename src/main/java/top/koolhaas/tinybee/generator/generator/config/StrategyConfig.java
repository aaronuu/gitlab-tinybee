...
public class StrategyConfig {
    ...
    /**
     * 【实体】是否为构建者模型（默认 false）<br> -----------------------------------<br> public User setName(String name) { this.name = name; return this; }
     */
    ...
    public boolean isCapitalModeNaming(String word) {
        return isCapitalMode && BaseUtil.isCapitalMode(word);
    }
    ...
    protected void convertSuperEntityColumns(Class<?> clazz) {
        ...
        if (CollectionUtils.isNotEmpty(fields)) {
            this.superEntityColumns = fields.stream().map(field -> {
                ...
                return BaseUtil.camelToUnderline(field.getName());
