...
public abstract class AbstractTemplateEngine {
    ...
    public AbstractTemplateEngine batchOutput() {
        try {
            ...
            for (TableInfo tableInfo : tableInfoList) {
                ...
                // domain.java
                if (null != tableInfo.getServiceAggName() && null != pathInfo.get(ConstVal.DOMAIN_PATH)) {
                    String domainFile = String.format((pathInfo.get(ConstVal.DOMAIN_PATH) + File.separator + tableInfo.getServiceAggName() + suffixJavaOrKt()), entityName);
                    if (isCreate(FileType.DOMAIN, domainFile)) {
                        writer(objectMap, templateFilePath(template.getDomain()), domainFile);
                    }
                }
            }
        } catch (Exception e) {
    ...
    public void open() {
        ...
        if (getConfigBuilder().getGlobalConfig().isOpen() && StrUtil.isNotEmpty(outDir)) {
            try {
    ...
    public Map<String, Object> getObjectMap(TableInfo tableInfo) {
        ...
        if (config.getStrategyConfig().isControllerMappingHyphenStyle()) {
            ...
            objectMap.put("controllerMappingHyphen", BaseUtil.camelToHyphen(tableInfo.getEntityPath()));
        }
        ...
        objectMap.put("codeConfig", config.getTransferCodeConfig());
